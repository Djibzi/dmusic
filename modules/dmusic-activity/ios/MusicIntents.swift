...
// Mirror of the widget-side intents — must stay byte-identical with
// targets/dmusicwidget/MusicIntents.swift. iOS routes the perform() call
// to the main-app process for LiveActivityIntent, so this is what actually
// runs when the user taps a button on the lock screen.
@available(iOS 17.0, *)
